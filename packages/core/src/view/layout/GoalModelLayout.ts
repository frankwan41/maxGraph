...
import { _mxCompactTreeLayoutNode,_mxCompactTreeLayoutLine } from './CompactTreeLayout';
import { findTreeRoots } from '../../util/treeTraversal';



/**
 * * @class GoalModelLayout
 * @extends {GraphLayout}
 * 
 * Extends {@link GraphLayout} to implement auto-layout for Motivaitonal
 * Models.
 *
 * Optional arguments:
...
export class GoalModelLayout extends GraphLayout {
    ...
    constructor(graph: Graph, levelDistance: number | null, nodeDistance: number | null) {
        super(graph);
    ...
    execute(parent: Cell, root?: Cell): void {
        ...
        if (root == null) {
            ...
            if (this.graph.getEdges(parent, parent.getParent(),
    ...
    */
     ...
     * Function: bridge
     */
    bridge(line1: _mxCompactTreeLayoutLine, x1: number, y1: number, line2: _mxCompactTreeLayoutLine, x2: number, y2: number) {
    ...
    apply(node: _mxCompactTreeLayoutNode, bounds: Rectangle | null = null): Rectangle | null {
        ...
        if (cell != null && g != null) {
            if (this.isVertexMovable(cell)) {
                g = <Rectangle>this.setVertexLocation(cell, node.x as number, node.y as number);
            }
    ...
    createLine(dx: number, dy: number, next: any = null): _mxCompactTreeLayoutLine {
        const line: _mxCompactTreeLayoutLine = {dx, dy, next};
...
export default GoalModelLayout;
